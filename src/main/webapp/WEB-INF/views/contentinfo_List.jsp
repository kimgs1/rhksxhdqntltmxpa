...
<script type="text/javascript" src="js/contentinfo_list.js"></script>
	...
	<div class="con1">
        <section class="board board_list">
            ...
            <div>
			 ...
			 test="${sessionScope.userInfo.login == true}"
                 -->
                 
			<c:if test="${sessionScope.userInfo.id == 'admin'}">
                <span><input type="button" style="cursor:hand" onclick="newContentInfo()" value="글쓰기" /></span>
                </c:if>
            </div>
