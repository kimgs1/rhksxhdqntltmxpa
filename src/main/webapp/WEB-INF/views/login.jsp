...
// 위 코드는 쿠키가 동작 할때 .... 현재는 동작 하지 않아서 임시로 넣음.
	$(document).ready(function(){ $("#txtUserId").focus(); });
</script>
                        ...
                        <div id="login" class="animate form">
                        	<form id="loginForm" action="login" method="post" autocomplete="on">
                                ...
                                <p>
									...
									<label for="user_id" class="uname" data-icon="u" > 사용자 아이디 </label>
									<!-- <input type="text" id="txtUserId" name="txtUserId" value="${check.id}" required="required" placeholder="아이디"> -->
									<input id="txtUserId" name="txtUserId" required="required" type="text" value="${check.id}" required="required" placeholder="아이디"/>
									</c:if>
									<c:if test="${check==null}">
									<label for="user_id" class="uname" data-icon="u" > 사용자 아이디 </label>
									<input id="txtUserId" name="txtUserId" required="required" type="text" required="required" placeholder="아이디"/>
									</c:if>
                                </p>
                                <p>

                                    <label for="password" class="youpasswd" data-icon="p"> 사용자 패스워드 </label>
                                ...
                                <p class="change_link">
									...
									<a href="#toregister" class="to_register">Join us</a>
									 -->
									<a href="javascript:void(0);" onclick="newMemberOnClick();" class="normal w900">사용자추가</a>
								</p>
                            </form>
                        </div>
