...
<script type="text/javascript" src="js/contentinfo_create.js"></script>
    ...
    <%@ include file="home_side.jsp"%>
	  <div class="con1">
        <section class="board board_write">
            <h2><img src="images/cs_download.jpg"></h2><!--자료실 공지사항-->
            <div>
                <table>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                        	<form id="FileUploadForm" action="#" enctype="multipart/form-data">
	                        	<input type="file" id="uploadFile" name="uploadFile" onchange="UploadFileFunc(this)" >
								<input type="text" id="uploadFileName" name="uploadFileName"hidden="true">                        
                       		</form>
                       </td>
                    </tr>
                </table>
                <div class="bo_write_save">
                    <input class="savebtn" type="button" style="cursor:hand" onclick="newContentInfoSave()" value="저장" />
