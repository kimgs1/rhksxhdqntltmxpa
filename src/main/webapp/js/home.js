		...
		success : function(data) {
			...
			if(dataList!= null){
				...
				grid.jqGrid({
					...
					datastr : dataList,
					colModel: [
					           {name:'name', label:'구분', align:'center', width:'6.6%'},
					           {name:'value',label:'Total', align:'center', width:'6.6%'},
					           {name:'val9',label:'환기', align:'center', width:'6.6%'},
					           {name:'val10',label:'내화', align:'center', width:'6.6%'},
					           {name:'val11',label:'방사선 차폐', align:'center', width:'6.6%'},
					           {name:'val12',label:'수밀', align:'center', width:'6.6%'},
					           {name:'val13',label:'내압', align:'center', width:'6.6%'},
					           {name:'val1',label:'양호', align:'center', width:'6.6%'},
					           {name:'val2',label:'미시공', align:'center', width:'6.6%'},
					           {name:'val3',label:'파손', align:'center', width:'6.6%'},
					           {name:'val4',label:'댐재 미제거', align:'center', width:'6.6%'},
					           {name:'val5',label:'전선관내 미시공', align:'center', width:'6.6%'},
					           {name:'val6',label:'CAP 미설치', align:'center', width:'6.6%'},
					           {name:'val7',label:'만족', align:'center', width:'6.6%'},
					           {name:'val8',label:'불만족', align:'center', width:'6.6%'},
					],
					pager: "#pager_list_1", 
					page : 1,
