...
public class PagingBean {
	 ...
	 * 한 페이지에서 보여줄 게시물 수 
	 */
	protected int numberOfContentPerPage=CommonConstants.CONTENT_NUMBER_PER_PAGE;
	/**
	 * 한 페이지 그룹내 페이지 수 
	 */
	protected int numberOfPageGroup=CommonConstants.PAGEGROUP_NUMBER_PER_PAGE;
	/**
	...
	public PagingBean(int totalContent, int nowPage, int numberOfContentPerPage  ,int numberOfPageGroup) {
		super();
		this.totalContent = totalContent;
		this.nowPage = nowPage;
	...
	public static void main(String args[]){
		PagingBean bean=new PagingBean(54000,10);
